...
export default function Login() {
  ...
  return(
    <main style={{ backgroundImage: `url(${imagePath})`, backgroundSize: "160px 160px" }} className='bg-violet-200 min-h-full flex items-center'>
      <title>Login</title>

      {/* <Image src={imagePath} alt="Umbrella Logo" fill={true} className="w-32 h-32 mx-auto mt-8" /> */}
      <div className="bg-white text-black border border-black rounded-lg mx-auto flex flex-col p-4 gap-4">
