  ...
  const menus = [
    {
      key: 'analysis',
      title: 'Analysis',
      link: `/dashboard/views/tree/student/${params.enrollment_id}/analysis`,
      icon: 'assessment',
    },
    {
      key: 'semester',
      title: 'Semester',
      link: `/dashboard/views/tree/student/${params.enrollment_id}/semester`,
      icon: 'school',
    },
    {
      key: 'resourses',
      title: 'Resourses',
      link: `/dashboard/views/tree/student/${params.enrollment_id}/resourses`,
      icon: 'library_books',
    },
    {
      key: 'results',
      title: 'Results',
      link: `/dashboard/views/tree/student/${params.enrollment_id}/results`,
      icon: 'school',
    },
    {
      key: 'activities',
      title: 'Activities',
      link: `/dashboard/views/tree/student/${params.enrollment_id}/activities`,
      icon: 'school',
    },
    {
      key: 'placements',
      title: 'Placements',
      link: `/dashboard/views/tree/student/${params.enrollment_id}/placements`,
      icon: 'school',
    },
  ]
