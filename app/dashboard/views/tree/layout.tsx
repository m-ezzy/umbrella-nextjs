  ...
  const menus: any = [
    {
      key: "student",
      title: "Student",
      link: "/dashboard/views/tree/student",
      icon: "person",
    },
    {
      key: "professor",
      title: "Professor",
      link: "/dashboard/views/tree/professor",
      icon: "person",
    },
    {
      key: "admin",
      title: "Admin",
      link: "/dashboard/views/tree/admin",
      icon: "person",
    },
    {
      key: "head",
      title: "Head",
      link: "/dashboard/views/tree/head",
      icon: "person",
    },
    {
      key: "director",
      title: "Director",
      link: "/dashboard/views/tree/director",
      icon: "person",
    },
  ];
    {/* Director Manager */}
