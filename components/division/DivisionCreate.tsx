...
export default function DivisionCreate({ batchs }: any) {
  ...
  return (
    <form action={createDivision} className="form mt-2 border rounded-md p-2 grid grid-cols-2 gap-2 items-center lg:grid-cols-10">
      ...
      <button type="submit" className="col-span-2 col-end-11">
